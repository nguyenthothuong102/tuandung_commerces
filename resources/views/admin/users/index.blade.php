...
<main class="app-layout-content">
  ...
  <button class="btn" type="submit"><i class="ion-ios-search-strong"></i></button>
    ...
    <div class="container-fluid p-y-md">
      ...
      <br>
    <!-- Card Tabs -->
     <h2 class="section-title"><a href="{{ route('admin.user.index') }}"> List Users </a>|| <a href="{{ route('admin.user.list_active') }}"> isActive </a> || <a href="{{ route('admin.user.create') }}"> Create Users </a></h2>
                                        ...
                                        <tbody>
                                          @foreach($users as $user)
                                              <tr class="bg-warning">
                                                ...
                                                <td class="text-center">{{ $user->isActive == 1 ? 'Đã Active' : ($user->isActive == 2 ? 'Chưa Active' : '') }}</td>
