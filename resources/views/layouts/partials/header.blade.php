            ...
            <div class="container">
                ...
                <div class="header_top">
                    ...
                    @else
                        ...
                        <li>
                            <a href="{{ route('admin.dashboard') }}" class="tr-bg-all tr-login-reg" >Admin Manager</a>
                        </li>
                        <li>
                            <a href="" class="tr-bg-all tr-login-reg" >Track Your Order</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="" class="tr-bg-all tr-login-reg" >{{ Auth::user()->first_name }}</a>
                            <a href="" class="tr-bg-all tr-login-reg" >Track Your Order</a>
                            <a href="{{ route('logout') }}" class="btn btn-default btn-flat"
                               onclick="event.preventDefault();
                                             document.getElementById('logout-form').submit();"
                ...
                <div class="header_middle sticky-header">
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-6">
                            <div class="logo text-center logo2">
                                <a class="logo_img" href="index.html"><img style="width:50px; height: 50px;" src="assets/img/logo/pintuandung.png" alt=""></a>
                                <div class="logo_text"> <p>Pin Tuấn dung</p></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 pin_be">
                            <div class="cong">+</div>
                            <div class="main_menu menu_position text-center pin">
                        ...
                        <div class="column1 col-lg-3 col-md-6">
                            <div class="categories_menu categories_three">
                                ...
                                <div class="categories_menu_toggle" style="display: none;">
                                    <ul>
                                        <li class="menu_item_children"><a href="#">Brake Parts <i class="fa fa-angle-right"></i><span class="expand"></span></a>
                                        ...
                                        <li class="menu_item_children"><a href="#"> Wheels &amp; Tires  <i class="fa fa-angle-right"></i><span class="expand"></span></a>
                                        ...
                                        <li class="menu_item_children"><a href="#"> Furnitured &amp; Decor <i class="fa fa-angle-right"></i><span class="expand"></span></a>
                                        ...
                                        <li class="menu_item_children"><a href="#"> Turbo System <i class="fa fa-angle-right"></i><span class="expand"></span></a>
                                            <ul class="categories_mega_menu column_2">
